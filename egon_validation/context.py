...
class RunContextFactory:
    ...
    @staticmethod
    def create_timestamped(prefix: str = "run", out_dir: Optional[str] = None) -> RunContext:
        ...
        logger.info(f"Created timestamped RunContext: {run_id}", 
    ...
    def create_airflow(
        ...
        logger.info(f"Created Airflow RunContext: {run_id}", 
    ...
    def create_unique(prefix: str = "run", out_dir: Optional[str] = None) -> RunContext:
        ...
        logger.info(f"Created unique RunContext: {run_id}", 

...
@register(task="adhoc", dataset="demand.egon_demandregio_hh", rule_id="SCENARIO_VALUES_VALID",
          kind="formal", column="scenario", expected_values=["eGon2035", "eGon2021", "eGon100RE"])
class ValueSetValidation(SqlRule):
    ...
    def postprocess(self, row, ctx):
        ...
        return RuleResult(
            ...
            success=ok, observed=invalid_values, expected=0.0,
...
register_map(
    ...
    datasets_params={
        "grid.egon_etrago_bus": {
            "column": "carrier", 
            "expected_values": [
                "rural_heat", "urban_central_water_tanks", "low_voltage", "CH4", 
                "H2_saltcavern", "services_rural_heat", "services_rural_water_tanks", 
                "central_heat_store", "AC", "Li_ion", "H2_grid", "dsm", 
                "urban_central_heat", "residential_rural_heat", "central_heat", 

...
class TestSqlRule:
    ...
    def test_check_table_empty_with_data(self, mock_fetch_one, mock_engine, mock_context):
    ...
    def test_check_empty_table(self, mock_fetch_one, mock_engine, mock_context):
        ...
        rule = SqlRule("test_rule", "test_task", "test.table", 
                      scenario_col="scenario", scenario="test_scenario")
        result = rule._check_table_empty(mock_engine, mock_context)
    ...
    @patch('egon_validation.db.fetch_one')
    def test_check_table_empty_exception(self, mock_fetch_one, mock_engine, mock_context):

...
class TestElectricalLoadAggregationValidation:
    def test_sql_generation(self):
        rule = ElectricalLoadAggregationValidation("test_rule", "test_task", "grid.egon_etrago_load", tolerance=0.05)
        sql = rule.sql(None)
    ...
    def test_postprocess_no_scenario_data(self):
        rule = ElectricalLoadAggregationValidation("test_rule", "test_task", "grid.egon_etrago_load")
    ...
    def test_postprocess_json_string_parsing(self):
        ...
        scenarios_data = [{"scn_name": "test", "load_sum_twh": 100, "load_max_gw": 10, "load_min_gw": 5}]
...
class TestDisaggregatedDemandSumValidation:
    def test_sql_generation_default_sector(self):
        rule = DisaggregatedDemandSumValidation("test_rule", "test_task", "demand.egon_demandregio_zensus_electricity")
        sql = rule.sql(None)
